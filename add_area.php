...
<body>
	...
	<section>
		...
		<ul class="form-list">
		<li>
			<div class="label-block"> <label for="areaName">Hospital Name</label> </div>
		...
		<li>
			<div class="label-block"> <label for="areaCode">hospital Code</label> </div>
		...
		<li>
			<input type="submit" value="Add hospital" class="submit_button" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
