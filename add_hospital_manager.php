...
<html>
<head>
	<title> Add Hospital managers </title>
...
<body>
	...
	<section>
		...
		<li>
			<input type="submit" value="Add Hospital manager" class="submit_button" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
