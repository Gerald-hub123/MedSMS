...
<aside>
	...
	--><a href="../admin/add_hospital_manager.php">Add Hospital managers</a><!--
	--><a href="../admin/add_manufacturer.php">Add Manufacturer</a><!--
	--><a href="../admin/add_driver.php">Add Driver</a><!--
	--><a href="../admin/view_unit.php">Manage Unit</a><!--
	--><a href="../admin/view_category.php">Manage Category</a><!--
	--><a href="../admin/view_hospital.php">Manage Hospitals</a><!--
